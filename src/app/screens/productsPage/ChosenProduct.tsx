...
/** REDUX SELECTOR */
const restaurantRetriever = createSelector(retrieveRestaurant, (restaurant) => ({ restaurant })) //9
const chosenProductRetriever = createSelector(retrieveProducts, (chosenProduct) => ({ chosenProduct })) //9
